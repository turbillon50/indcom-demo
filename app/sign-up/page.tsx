        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 20 }}>
            {[{ k:'nombre', ph:'Nombre completo', t:'text' },
              { k:'empresa', ph:'Empresa (opcional)', t:'text' },
          ...
          <motion.button whileTap={{ scale: .97 }} onClick={handleSignup} disabled={loading}
            ...
            {loading
              ...
              : <><i className="ti ti-user-plus" style={{ fontSize: 18 }} />Crear cuenta</>
            }
          </motion.button>
          <p style={{ textAlign: 'center', fontSize: 13, color: 'var(--txt3)', marginTop: 20 }}>
            ¿Ya tienes cuenta?{' '}
            <Link href="/sign-in" style={{ color: 'var(--violet)', fontWeight: 600, textDecoration: 'none' }}>
              Ingresar
            </Link>
          </p>
        </motion.div>
