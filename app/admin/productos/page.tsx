    ...
    <div style={{padding:16}}>
      <div style={{display:'flex',gap:10,marginBottom:14}}>
        <div style={{flex:1,position:'relative'}}>
          <i className="ti ti-search" style={{position:'absolute',left:11,top:'50%',
            transform:'translateY(-50%)',color:'var(--txt3)',fontSize:14}} />
        ...
        <button onClick={()=>toast.info('Nuevo producto')}
          ...
          <i className="ti ti-plus" style={{fontSize:15}} />Nuevo
        </button>
      </div>
        ...
        {filtered.map((p,i)=>{
          ...
          return (
            <motion.div key={p.id} initial={{opacity:0,y:6}} animate={{opacity:1,y:0}}
              ...
              <div style={{width:44,height:44,borderRadius:13,background:m.color+'15',
              ...
              <div style={{textAlign:'right',flexShrink:0}}>
                ...
                <p style={{fontSize:10,fontWeight:600,color:p.stock>10?'var(--green)':p.stock>0?'var(--gold)':'var(--red)'}}>
                  {p.stock} uds
                </p>
              </div>
